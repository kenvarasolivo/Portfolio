...
export const translations = {
  ...
  // ── Hero ──
  'hero.eyebrow': {
    en: 'Software Engineer · Aachen, DE',
    de: 'Softwareentwickler · Aachen, DE',
  },
  'hero.title': {
    en: 'I build useful software from idea to shipped product.',
    de: 'Ich entwickle nützliche Software von der Idee bis zum fertigen Produkt.',
  },
  'hero.tagline': {
    en: "I'm Ken, a Computer Science student at FH Aachen. I shape user flows, build the frontend and backend, and add AI where it helps.",
    de: 'Ich bin Ken, Informatikstudent an der FH Aachen. Ich gestalte Nutzerabläufe, entwickle Frontend und Backend und ergänze KI, wo sie sinnvoll ist.',
  },
  ...
  'spec.1.a': { en: 'Responsive layouts and navigation', de: 'Responsive Layouts und Navigation' },
  'spec.1.b': { en: 'Onboarding, forms, and feedback', de: 'Onboarding, Formulare und Feedback' },
  'spec.1.c': { en: 'Reusable components and consistent styling', de: 'Wiederverwendbare Komponenten und einheitliches Design' },

  'spec.2.title': {
    en: 'Applied AI',
    de: 'Angewandte KI',
  },
  'spec.2.a': { en: 'Chat and streaming responses', de: 'Chat und gestreamte Antworten' },
  'spec.2.b': { en: 'Retrieval from documents and app data', de: 'Suche in Dokumenten und Anwendungsdaten' },
  'spec.2.c': { en: 'Structured outputs and tool calling', de: 'Strukturierte Ausgaben und Tool-Aufrufe' },

  'spec.3.title': {
    en: 'Full-stack products',
    de: 'Full-Stack-Produkte',
  },
  'spec.3.a': { en: 'Frontend, APIs, and database integration', de: 'Frontend, APIs und Datenbankanbindung' },
  'spec.3.b': { en: 'Accounts, roles, and admin tools', de: 'Konten, Rollen und Verwaltung' },
  'spec.3.c': { en: 'Deployment and ongoing improvements', de: 'Deployment und Weiterentwicklung' },
